...
class SklearnClfModel():
    
    def __init__(self, model):
        self.trials = Trials()
        
        # The classifier to use, e.g. RandomForestClassifier from sklearn
        self.model = model
    ...
    def optimize(self, space, df_train, features, target, kf, output_file=None):
        ...
        # fit a model with the best parameters on the whole training data
        self.best_model = self.model(**best)
        self.best_model.fit(df_train[self.features], df_train[self.target])
